...
VERSION_REGEX = re.compile(
    r"__version__\s*=\s*'(?P<version>[0-9]+\.[0-9]+\.[0-9]+(?P<pre>-[0-9a-zA-Z]+)?)'"
)


def get_version() -> str:
    version_file = join(THIS_DIR, 'mymodule', 'version.py')
...
setup(
    ...
    url='https://github.com/jynik/rtd_test',
    ...
    project_urls={
        'Source': 'https://github.com/jynik/rtd_test',
        'Issue Tracker': 'https://github.com/jynik/rtd_test/issues',
    },
)
